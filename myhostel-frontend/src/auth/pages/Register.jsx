...
const Register = () => {
    ...
    return (
        <div
            className="min-h-screen w-full bg-[#fdf9f6] flex flex-col items-center justify-start md:justify-center px-4 py-8 md:py-10"
                    ...
                    <form onSubmit={handleRegister} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                {/* Full name spans full width on sm+ */}
                        ...
                        <div>
                            ...
                            >
                                <input
                                    type="file" id="idUpload" className="hidden"
