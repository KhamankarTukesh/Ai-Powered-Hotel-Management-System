...
const WardenRoomManager = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fffaf5] flex flex-col font-display">

      {/* Header */}
      <div className="p-4 md:px-10 md:pt-10 pb-4 max-w-7xl mx-auto w-full">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl sm:text-4xl font-black text-slate-900 italic uppercase tracking-tighter">Inventory</h1>
      ...
      <div className="flex-1 overflow-hidden max-w-7xl mx-auto w-full px-4 md:px-10 pb-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 h-full">
          ...
          <div className="lg:col-span-4 h-full overflow-y-auto pr-0 lg:pr-2 custom-scrollbar">
            <div className="bg-white p-6 rounded-[2rem] shadow-xl border border-orange-50 mb-4">
              ...
              <form onSubmit={handleAllocate} className="space-y-5">
                ...
                <div className="space-y-2 relative">
                  ...
                  <div className="relative">
                    ...
                    />
                    <input
                      className="w-full pl-12 pr-4 py-4 bg-slate-50 rounded-2xl font-bold outline-none focus:ring-2 ring-orange-200 transition-all text-sm sm:text-base"
                      placeholder="Ex: CSE2025"
                      value={searchQuery}
                      onChange={(e) => { setSearchQuery(e.target.value); setIsSelected(false); }}
                    />
                  </div>
                      ...
                      {filteredStudents.length > 0 ? (
                        filteredStudents.map((item) => (
                          <div
                            ...
                            onClick={() => { setSearchQuery(item.student.fullName); setIsSelected(true); }}
                          ...
                          >
                            <div>
                              <p className="font-bold text-slate-800 group-hover:text-orange-600 transition-colors truncate max-w-[150px]">
                ...
                <div className="space-y-2">
                  ...
                  <div className={`p-4 rounded-2xl border transition-all duration-300 text-sm sm:text-base ${
            ...
            {/* Extra Card */}
            <div className="bg-white p-5 rounded-[2rem] mb-2 shadow-xl border border-orange-50 mt-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          {/* Right Column */}
          <div className="lg:col-span-8 h-full max-h-[80vh] overflow-y-auto pr-0 lg:pr-2 custom-scrollbar">
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 pb-10 pl-0 sm:pl-5 pt-5">
                {rooms.map((room) => (
                  <div
                    key={room._id}
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <h3 className="text-xl font-black text-slate-800 truncate">Room {room.roomNumber}</h3>
                    ...
                    <div className="mt-6 flex gap-1.5">
                      {room.beds.map((bed) => (
                        <div
                          key={bed._id}
                          className={`flex-1 h-1.5 rounded-full transition-all duration-500 ${bed.isOccupied ? 'bg-slate-200' : 'bg-green-400'}`}
