...
import { Search, CheckCircle, XCircle, Clock, ExternalLink, Loader2, MessageSquare, UserCircle } from "lucide-react";
...
const WardenLeaveManagement = () => {
  ...
  // Filter by Name or Roll Number as requested
                  ...
                  <>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button 
                         ...
                         className="px-4 py-3 bg-red-50 text-red-500 rounded-xl hover:bg-red-500 hover:text-white transition-colors"
                      >
                        <XCircle size={18} />
                      </button>
                    </div>
