...
// ✅ Skeleton — same size as student dashboard
const CardSkeleton = () => (
  <div className="bg-orange-50 rounded-2xl h-36 animate-pulse border border-orange-100" />
);
  ...
  return (
    <Suspense fallback={
      ...
      <div className="relative min-h-screen w-full bg-[#fffaf5] selection:bg-orange-100">
        ...
        <div className="relative w-full max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-10 py-8 sm:py-10 lg:py-14">
          ...
          {/* ── Stats Grid — same pattern as StudentDashboard ── */}
          <Suspense fallback={
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 sm:gap-6 lg:gap-8">
              {[...Array(9)].map((_, i) => <CardSkeleton key={i} />)}
            </div>
          }>
            {/* ✅ Row 1 — 4 columns (key stats) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 sm:gap-6 lg:gap-8 mb-5">
            ...
            {/* ✅ Row 2 — 3 columns (management) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-6 lg:gap-8 mb-5">
            ...
            {/* ✅ Row 3 — 2 columns (notices + activity) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 lg:gap-8 mb-8">
